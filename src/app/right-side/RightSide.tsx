...
const RightSide = () => {
    return (
        <div className={"right-container absolute right-0 w-[65%] max-w-[900px]"}>
            <div className={"m-5 max-w-[700px]"}>
                <p className="leading-relaxed">I am a full-stack software engineer with ~10 years of experience delivering scalable, high-impact applications across healthcare, retail, insurance, and e-commerce.
